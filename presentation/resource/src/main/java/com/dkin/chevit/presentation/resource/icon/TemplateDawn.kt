...
public val ChevitIcon.TemplateDawn: ImageVector
    get() {
        if (_templateDawn != null) {
            return _templateDawn!!
        }
        _templateDawn = Builder(name = "TemplateDawn", defaultWidth = 88.0.dp, defaultHeight =
...
private var _templateDawn: ImageVector? = null
