...
public val ChevitIcon.TemplateCheckOff: ImageVector
    get() {
        if (_templateCheckOff != null) {
            return _templateCheckOff!!
        }
        _templateCheckOff = Builder(name = "TemplateCheckOff", defaultWidth = 13.0.dp, defaultHeight
                = 12.0.dp, viewportWidth = 13.0f, viewportHeight = 12.0f).apply {
            path(fill = SolidColor(Color(0xFF8785FF)), stroke = SolidColor(Color(0xFF9B99FF)),
...
private var _templateCheckOff: ImageVector? = null
