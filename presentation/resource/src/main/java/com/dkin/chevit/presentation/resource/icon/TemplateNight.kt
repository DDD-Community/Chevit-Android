...
public val ChevitIcon.TemplateNight: ImageVector
    get() {
        if (_templateNight != null) {
            return _templateNight!!
        }
        _templateNight = Builder(name = "TemplateNight", defaultWidth = 88.0.dp, defaultHeight =
                66.0.dp, viewportWidth = 88.0f, viewportHeight = 66.0f).apply {
            group {
                path(fill = SolidColor(Color(0xFFC3C2FF)), stroke = null, strokeLineWidth = 0.0f,
                ...
                path(fill = SolidColor(Color(0xFF8785FF)), stroke = SolidColor(Color(0xFF8785FF)),
                        strokeLineWidth = 1.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(70.5039f, 29.2705f)
                    horizontalLineTo(18.375f)
                    curveTo(11.4714f, 29.2705f, 5.875f, 34.867f, 5.875f, 41.7705f)
                    verticalLineTo(71.3452f)
                    curveTo(5.875f, 78.2488f, 11.4714f, 83.8452f, 18.375f, 83.8452f)
                    horizontalLineTo(70.5039f)
                    curveTo(77.4075f, 83.8452f, 83.0039f, 78.2488f, 83.0039f, 71.3452f)
                    verticalLineTo(41.7705f)
                    curveTo(83.0039f, 34.867f, 77.4075f, 29.2705f, 70.5039f, 29.2705f)
                    close()
                }
                path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF8785FF)),
...
private var _templateNight: ImageVector? = null
