...
public val ChevitIcon.IconCheckboxUncheckedGrey: ImageVector
    get() {
        if (_iconCheckboxUncheckedGrey != null) {
            return _iconCheckboxUncheckedGrey!!
        }
        _iconCheckboxUncheckedGrey = Builder(name = "IconCheckboxUncheckedGrey", defaultWidth =
                24.0.dp, defaultHeight = 25.0.dp, viewportWidth = 24.0f, viewportHeight =
                25.0f).apply {
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFFB9B9B9)),
...
private var _iconCheckboxUncheckedGrey: ImageVector? = null
