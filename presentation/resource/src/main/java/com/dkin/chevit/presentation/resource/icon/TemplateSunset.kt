...
public val ChevitIcon.TemplateSunset: ImageVector
    get() {
        if (_templateSunset != null) {
            return _templateSunset!!
        }
        _templateSunset = Builder(name = "TemplateSunset", defaultWidth = 88.0.dp, defaultHeight =
                66.0.dp, viewportWidth = 88.0f, viewportHeight = 66.0f).apply {
            group {
                path(fill = SolidColor(Color(0xFFFD7A1B)), stroke = null, strokeLineWidth = 0.0f,
                ...
                path(fill = SolidColor(Color(0xFFFFAE63)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFFFFAE63)),
...
private var _templateSunset: ImageVector? = null
