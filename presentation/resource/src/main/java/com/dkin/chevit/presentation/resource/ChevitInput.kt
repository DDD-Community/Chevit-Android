    ...
    Column {
        TextField(
            ...
            colors = TextFieldDefaults.colors(
                ...
                focusedIndicatorColor = if (isInputError) ChevitTheme.colors.statusError else ChevitTheme.colors.grey4,
                unfocusedIndicatorColor = if (isInputError) ChevitTheme.colors.statusError else ChevitTheme.colors.grey4,
                disabledIndicatorColor = if (isInputError) ChevitTheme.colors.statusError else ChevitTheme.colors.grey4,
                errorIndicatorColor = if (isInputError) ChevitTheme.colors.statusError else ChevitTheme.colors.grey4,
