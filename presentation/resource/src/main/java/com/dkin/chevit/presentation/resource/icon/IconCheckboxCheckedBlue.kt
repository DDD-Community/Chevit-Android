...
public val ChevitIcon.IconCheckboxCheckedBlue: ImageVector
    get() {
        if (_iconCheckboxCheckedBlue != null) {
            return _iconCheckboxCheckedBlue!!
        }
        _iconCheckboxCheckedBlue = Builder(name = "IconCheckboxCheckedBlue", defaultWidth = 24.0.dp,
...
private var _iconCheckboxCheckedBlue: ImageVector? = null
