...
public val ChevitIcon.TemplateAfternoon: ImageVector
    get() {
        if (_templateAfternoon != null) {
            return _templateAfternoon!!
        }
        _templateAfternoon = Builder(name = "TemplateAfternoon", defaultWidth = 88.0.dp,
                defaultHeight = 66.0.dp, viewportWidth = 88.0f, viewportHeight = 66.0f).apply {
            group {
                path(fill = SolidColor(Color(0xFFFF9534)), stroke = null, strokeLineWidth = 0.0f,
                ...
                path(fill = SolidColor(Color(0xFFFFC38C)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                ...
                path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFFFFC38C)),
...
private var _templateAfternoon: ImageVector? = null
